...
add_action('carbon_fields_register_fields', 'crb_stocks');
add_action('init', 'register_post_stocks');

function register_post_stocks() {
...
function crb_stocks() {
	Container ::make('post_meta', __('Вид остекления'))
	          -> where('post_type', '=', 'stocks')
	          -> add_tab(__('Отображение на главной странице'), [
		          Field ::make('image', 'stocks_img', __("Картинка акции"))
		                -> set_value_type('url'),
		          Field ::make('text', 'stocks_title', __("Заголовок акции")),
		          Field ::make('text', 'stocks_desc', __("Описание акции")),
		          Field ::make('text', 'stocks_meta_title', __("SEO TITLE")),
		          Field ::make('text', 'stocks_back_link', __('Техническое поле для ссылок (Не трогать!)'))
		                -> set_default_value('akczii'),
	          ])
	          -> add_tab(__('Настройка отображения записи'), [
		          Field ::make('text', 'post_main_title', __('Заголовок статьи')),
		          Field ::make('complex', 'stocks_post_item', __('Данные статьи'))
		                -> setup_labels([
		                ...
		                -> add_fields(array(
			                ...
			                Field ::make('separator', 'stocks_separator', __('Данные по тексту')),
