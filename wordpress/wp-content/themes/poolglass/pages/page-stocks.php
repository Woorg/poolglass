...
<main class="page-stocks">
  <div class="page-stocks__container">
    <div class="stocks__content">

			<?php foreach($my_posts as $post): ?>

        <div class="stocks__block block-stocks">
          <a class="block-stocks__img" href="<?php echo $post -> guid; ?>"><img
                    src="<?php echo carbon_get_post_meta($post -> ID, 'stocks_img'); ?>" alt=""></a>
          <div class="block-stocks__title"> <?php echo carbon_get_post_meta($post -> ID, 'stocks_title') ?> </div>
          <div class="block-stocks__note"><?php echo carbon_get_post_meta($post -> ID, 'stocks_desc') ?></div>
        </div>
