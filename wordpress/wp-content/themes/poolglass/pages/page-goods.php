...
<main class="page-articles">
  <div class="page-articles__container page-goods__container">
    <div class="page-goods__wrapper">
			...
			if($query -> have_posts()):
				while($query -> have_posts()): $query -> the_post();
					?>
          <div class="page-goods__item item-goods">
            <div class="item-goods__title"><a href="<?php echo get_permalink(); ?>"><?php the_title() ?></a></div>
            <div class="item-goods__descr"><?php echo carbon_get_post_meta(get_the_ID(), 'goods_desc'); ?></div>
            <div class="item-goods__circle"><a href="<?php echo get_permalink(); ?>"><img
                        src="<?php echo carbon_get_post_meta(get_the_ID(), 'goods_img'); ?>" alt=""></a></div>
          </div>
				<?php
				endwhile;
			endif;
