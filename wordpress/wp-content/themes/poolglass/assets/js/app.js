 ...
 */
    ...
    (() => {
        ...
        document.addEventListener("click", (function(e) {
            ...
            } else if (event.classList.contains("pagination-projects__next")) nextPage(); else if (event.classList.contains("pagination-projects__before")) prevPage();
        }));
        ...
        function nextPage() {
            for (let index = 0; index < nums.length; index++) {
                ...
                if (element.classList.contains("numbers-projects__active") && index != nums.length - 1) {
        ...
        function prevPage() {
            for (let index = 0; index < nums.length; index++) {
                const element = nums[index];
                if (element.classList.contains("numbers-projects__active") && 0 != index) {
                    element.classList.remove("numbers-projects__active");
                    nums[index - 1].classList.add("numbers-projects__active");
                    break;
                }
