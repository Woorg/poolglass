...
function reset_image_sizes(): void
{
  ...
  update_option('thumbnail_size_h', ratio(450, 'square'));
...
function get_media(
  ...
  if ($src) {
    ...
    if (get_post_mime_type($id) === 'image/svg+xml') {
      ...
      $media =
        '<figure class="media--element ' . $orientation . ' ' . $type . '"';
    ...
    $media =
      '<div class="media--element"><div class="media--object media--placeholder"></div></div>';
  }
