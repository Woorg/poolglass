...
domReady(async () => {
  ...
  //     }
  //   }
  //   const nums = document.querySelectorAll('.numbers-projects__num');
  //   // Event delegation for pagination buttons and number selection
  //   document.addEventListener('click', function (e) {
  //     let event = e.target;
  //     // Handling click on project numbers
  //     if (event.classList.contains('numbers-projects__num')) {
  //       deleteActivePagination();
  //       event.classList.add('numbers-projects__active');
  //     }
  //     // Handling click on "next" button
  //     else if (event.classList.contains('pagination-projects__next')) {
  //       nextPage();
  //     }
  //     // Handling click on "previous" button
  //     else if (event.classList.contains('pagination-projects__before')) {
  //       prevPage();
  //     }
  //   });
  //   // Function to remove active class from all number items
  //   function deleteActivePagination() {
  //     nums.forEach(function (num) {
  //       num.classList.remove('numbers-projects__active');
  //     });
  //   }
  ...
  //       if (
  //         element.classList.contains('numbers-projects__active') &&
  //         index !== nums.length - 1
  //       ) {
  //         element.classList.remove('numbers-projects__active');
  //         nums[index + 1].classList.add('numbers-projects__active');
  //         break;
  //       }
  //     }
  //   }
  ...
  //     }
  //   }
  //   // Call other functions if needed (example)
  //   window['FLS'] = true; // This seems to be a flag for some other functionality
  //   isWebp(); // Assuming you want to check for WebP support (replace with actual function if available)
  //   menuInit(); // Assuming this initializes a menu (replace with actual function if available)
  //   tabs(); // Assuming this initializes tabs (replace with actual function if available)
  //   formFieldsInit({
  //     viewPass: false, // Assuming this initializes form fields (replace with actual function if available)
  //   });
  //   formSubmit(); // Assuming this handles form submission (replace with actual function if available)
  // });
});
