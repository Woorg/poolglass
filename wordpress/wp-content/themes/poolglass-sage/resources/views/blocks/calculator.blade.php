<div x-data="calculator()" class="calculator {{ $block->classes }}"
  ...
  <div class="calculator__container container">
    ...
    <figure class="calculator__image">
      ...
      <img x-show="window_shape
        ...
        src="@asset('public/assets/images/round-wall.webp')" />
      <img x-show="window_shape === 'Прямоугольное окно'" x-transition
        src="@asset('public/assets/images/rectangle-wall.webp')" />
      <img x-show="window_shape === 'Трехопорная панель'" x-transition
        src="@asset('public/assets/images/three-point-wall.webp')" />
      <img x-show="window_shape === 'Панель с переливом'" x-transition
        src="@asset('public/assets/images/overflow-wall.webp')" />
      <img x-show="window_shape === 'Прямоугольное окно в дне бассейна'"
        x-transition src="@asset('public/assets/images/rectangle-floor.webp')" />
    </figure>
